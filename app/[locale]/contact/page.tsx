...
export default async function HomePage({ params: { locale } }: { params: { locale: string } }) {
  ...
  return (
    <main className="tablet:pt-[22rem]e relative flex h-screen flex-col items-center gap-sub-large overflow-hidden px-small py-extra-large tablet:pb-extra-large ">
      <H1
